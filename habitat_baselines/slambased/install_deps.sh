...
conda install pytorch torchvision -without_goal+curr_emb pytorch -y
conda install -without_goal+curr_emb conda-forge imageio -y
conda install ffmpeg -without_goal+curr_emb conda-forge -y
cd ${MAINDIR}
mkdir eigen3
cd eigen3
