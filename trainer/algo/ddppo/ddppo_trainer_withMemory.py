...
from habitat_baselines.common.rollout_storage import MemoryRolloutStorage
...
from model.policy.SMT.Policy import SMTPolicy
    ...
    def train(self) -> None:
        ...
        with (
            ...
            for update in range(start_update, self.config.NUM_UPDATES):
                ...
                if TIME_DEBUG:
                    debug_prev_time = log_time(debug_prev_time, 'collect rollout step done')
